...
Para comrpobarlo con una IP que no sea maliciosa usamos el mismo comando pero cambiamos la IP a verificar, por ejemplo la 8.8.8.8. Y el flujo no llegará hasta el final:
